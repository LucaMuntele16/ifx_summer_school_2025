...
class ifx_dig_test_status extends ifx_dig_testbase;
    `uvm_component_utils(ifx_dig_test_status)

    int filter_list[$];
    int reg_addresses[$];

    function new(string name = "ifx_dig_test_status", uvm_component parent);
